#ifndef SAHARA_QUEUE_H
#define SAHARA_QUEUE_H

// Copied from DSDV routing algorithm (Copyright (c) 2010 Hemanth Narra)
...
class PacketQueue
{
  public:
    ...
    std::vector<Ipv4Address> GetAllPacketsDest();
  ...
  private:
    ...
    uint32_t m_maxLen = 10;
    /// The maximum number of packets that we allow per destination to buffer.
    uint32_t m_maxLenPerDst = 10;
